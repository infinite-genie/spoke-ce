...
```ts
export const space = {
  0: 0, px: 1, 0.5: 2, 1: 4, 2: 8, 3: 12, 4: 16,
...
export const fontSize = {
  xs: 11, sm: 13, base: 15, md: 16, lg: 18, xl: 22, '2xl': 28,
};
...
export const zIndex = {
  base: 0, sticky: 100, dropdown: 1000, overlay: 1100,
  modal: 1200, popover: 1300, toast: 1400, tooltip: 1500,
};
```
